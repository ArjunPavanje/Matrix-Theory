...
\begin{enumerate}
    \begin{multicols}{2}
        \item \begin{align*}
            X &= c_0s + c_1\\
			Y &= \frac{1}{(s^2 + a_0s + a_1)}\\
            Z &= b_0s + b_1
        \end{align*}
    \columnbreak
        \item \begin{align*}
            X &= 1 \\
            Y &= \frac{(c_0s + c_1)}{(s^2 + a_0s + a_1)} \\
            Z &= b_0s + b_1
        \end{align*}
    \end{multicols}
    \begin{multicols}{2}
        \item \begin{align*}
            X &= c_0s + c_1 \\
            Y &= \frac{(b_1s + b_0)}{(s^2 + a_1s + a_0)} \\
            Z &= 1
        \end{align*}
    \columnbreak
        \item \begin{align*}
            X &= c_0s + c_1 \\
			Y &= \frac{1}{(s^2 + a_1s + a_0)} \\
            Z &= b_1s + b_0
        \end{align*}
    \end{multicols}
\end{enumerate}
\item The value of $\oint_{C}\frac{dz}{(1+z^{2})}$, where C is the contour $\abs{z-\frac{i}{2}}=1$ is
\begin{enumerate}
    \begin{multicols}{2}
        \item $2\pi i$
    \columnbreak
...
\begin{figure}[H]
			\centering
			\includegraphics[scale=1]{figs/fig50.png}
			\label{stemplot}
		\end{figure}
\begin{enumerate}
    \begin{multicols}{2}
