...
\item Show that $16\brak{\cos\brak{\frac{2\pi}{15}}}\brak{\cos\brak{\frac{4\pi}{15}}}\brak{\cos\brak{\frac{8\pi}{15}}}\\\brak{\cos\brak{\frac{16\pi}{15}}}=1$ \hfill\brak{1983-2 Marks}
...
\item Determine the smallest positive value of $x$ \brak{in degrees} for which $\tan {\brak{x+100^{\circ}}}=\tan {\brak{x+50^{\circ}}}\tan \brak{x}\tan {\brak{x-50^{\circ}}}$\\
\hfill\brak{1993-5 Marks}
\item Find the smallest positive number $p$ for which the equation $\cos {\brak{p\sin \brak{x}}}=\sin {\brak{p\cos \brak{x}}}$ has a solution $ x \in [0, \pi]$
\hfill\brak{1995- 5 Marks}
\item Find all values of $\theta$ in the interval $\brak{-\frac{\pi}{2},\frac{\pi}{2}}$ satisfying the equation $\brak{1-\tan \brak{\theta}}\brak{1+\tan \brak{\theta}}\sec^2\brak{\theta}+ 2^{\tan^2\brak{\theta}}=0$\\
...
\item Prove that $\sum_{k=1}^{n-1}$ $\brak{n-k}\cos\brak{ \frac{2k\pi}{n}}=-\frac{n}{2}$, where $n\ge$3
\hfill\brak{1997-5 Marks}
\item In any triangle $ABC$, prove that $\cot \brak{\frac{A}{2}}+\cot \brak{\frac{B}{2}}+\cot \brak{\frac{C}{2}}=\cot \brak{\frac{A}{2}}\cot \brak{\frac{B}{2}}\cot \brak{\frac{C}{2}}$\\
\hfill\brak{2000-3 Marks}
\item Find the range of values of for which $2\sin \brak{t} = \frac{1-2x+5x^2}{3x^2-2x-1}$, t $\in \left[-\frac{\pi}{2},\frac{\pi}{2}\right]$
